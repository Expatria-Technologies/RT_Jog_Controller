...
static void draw_main_screen(bool force){ 
  ...
  case DEFAULT:  
      ...
      switch (packet->machine_state){
        ...
        sprintf(charbuf, "%3.3f    %2d    jg", packet->jog_stepsize, packet->jog_mode.value);
        oledWriteString(&oled, 0,0,6,charbuf, FONT_6x8, 0, 1);          
        ...
        case MachineState_Homing : //no overrides during homing
          oledFill(&oled, 0,1);
        ...
        case MachineState_Alarm : //no overrides during homing
          oledFill(&oled, 0,1);
          oledWriteString(&oled, 0,0,0,(char *)" *****************", FONT_6x8, 0, 1);
          oledWriteString(&oled, 0,0,7,(char *)" *****************", FONT_6x8, 0, 1);
          //no jog during hold
